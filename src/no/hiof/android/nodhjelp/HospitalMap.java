...
public class HospitalMap extends ActionBarActivity implements 
		LocationListener, 
	...
	public void Reader(String string){
		...
		LatLng nearestHos = new LatLng(Double.valueOf(myHospital.HealthServiceLatitude), Double.valueOf(myHospital.HealthServiceLongitude));
		String displayName = new String(myHospital.HealthServiceDisplayName);
		
		map.setOnMarkerClickListener(this);
		
		Marker Hos = map.addMarker(new MarkerOptions()
		.position(nearestHos)
		.title(displayName));
	...
	public boolean onMarkerClick(Marker marker) {
		UtilHospitalCall.alertMessage(myHospital.HealthServiceDisplayName, myHospital.HealthServicePhone, HospitalMap.this);
		return false;
	}
